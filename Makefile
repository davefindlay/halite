...
FILE=halite-2-gold-replays.zip 
#replays-20170930-sample.zip
...
models/model_long_training.ckpt.meta: data/${FILE} ${SOURCES_FOR_TRAINING}
	mkdir -p models/
	python3 -m tsmlstarterbot.train --model_name model_long_training --data data/${FILE} --games_limit 10 --steps 5000 --seed ${SEED}
